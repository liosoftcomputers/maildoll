                ...
                <div class="p-5">
                    ...
                    <section id="Infobip">
                        ...
                        <ul>
                            ...
                            <li> - Command example: <strong>/usr/local/bin/php/home/hosting-username/laravel-folder/artisan command >> /dev/null</strong></li>
                            ...
                            <li> <br> <img src="{{ asset('cronjobs/1.png') }}" alt=""> <br> </li>
                            <li> <br> <img src="{{ asset('cronjobs/2.png') }}" alt=""> <br> </li>
