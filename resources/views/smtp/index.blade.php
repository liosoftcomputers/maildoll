            ...
            <div class="flex items-start px-5 pt-5">
                <div class="w-full flex flex-col lg:flex-row items-center">
                    <div class="w-16 h-16 image-fit">
                        <img alt="Maildoll" class="rounded-md" src="{{ mailLogo('gmail') }}">
                    </div>
...
<div class="intro-y col-span-12 md:col-span-6 lg:col-span-6">
    <div class="box {{ defaultMail('yahoo') }}">
        <div class="flex items-start px-5 pt-5">
            <div class="w-full flex flex-col lg:flex-row items-center">
                <div class="w-16 h-16 image-fit">
                    <img alt="Maildoll" class="rounded-md" src="{{ mailLogo('yahoo') }}">
                </div>
                <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                    @translate(Yahoo)
                </div>
...
<div class="intro-y col-span-12 md:col-span-6 lg:col-span-6">
    <div class="box {{ defaultMail('webmail') }}">
        <div class="flex items-start px-5 pt-5">
            <div class="w-full flex flex-col lg:flex-row items-center">
                <div class="w-16 h-16 image-fit">
                    <img alt="Maildoll" class="rounded-md" src="{{ mailLogo('webmail') }}">
                </div>
                <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                    @translate(Webmail)
                </div>
...
<div class="intro-y col-span-12 md:col-span-6 lg:col-span-6">
    <div class="box {{ defaultMail('mailgun') }}">
        <div class="flex items-start px-5 pt-5">
            <div class="w-full flex flex-col lg:flex-row items-center">
                <div class="w-16 h-16 image-fit">
                    <img alt="Maildoll" class="rounded-md" src="{{ mailLogo('mailgun') }}">
                </div>
                <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                    @translate(Mailgun)
                </div>
